						...
						<div className="px-4 sm:px-0 sticky top-24">
							...
							<VerticalSteps
								steps={[
									...
									{
										title: "Committee and Partner Preferences",
										description:
											"Now comes the fun part! Look into the different committees offered at this conference and indicate how much you like each one.",
									},
									{
										title: "Donations",
										description:
											"To cover fees charged by this conference, we need to request request a donation, which will go directly towards making this conference possible.",
									},
									{
										title: "You're Done!",
										description:
											"You're now registered! You may still edit or cancel your registration until the deadline.",
									},
								]}
								currentStep={step}
