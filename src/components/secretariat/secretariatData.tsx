...
function ExpandableBio({
	...
	return (
		<>
			{pre}
			<button
				className={"underline text-indigo-500 active:text-indigo-800"}
...
export default [
	...
	},
	{
		...
		memeBio: (
			<ExpandableBio
				pre={
					<p>
						Nelson is one of those boys that you’ll spot sitting at
						a desolate part of the hallway looking directly downward
						at his phone likely playing some new battle royale phone
						game. Surrounding him are his comrades, compadres,
						cohorts all strangely chuckling to themselves. Hopefully
						you see this Nelson before you come to a meeting. Then
						you don’t have to go the other way around in getting to
						know Nelson. The Nelson most people see is at meetings
						leading those iconic one way conversations, but there is
						more to this man than meets the eyes and ears.
					</p>
				}
				post={
					<p>
						For instance, combine those two words at the beginning
						of the last sentence and then a ‘t’ after the ‘s’ and
						paste that after ‘youtube.com/’ and just a few months
						ago you could have uncovered a motherload of the hottest
						content on that website. Those one way conversations are
						just the beginning of the journey to the center of
						nelson’s mind and back out. Here are some other insights
						that can kickstart anyone’s relationship with Nelson: at
						conferences he will ‘sleep’ in bed with all of the lamp
						lights in the hotel room on and perhaps diffuse into
						another dimension before five minutes later suddenly
						sitting up erect and saying some variation of: “Alright,
						got to get some work done,” he says that food is just
						fuel and will inhale his fuel to power that large
						machine of his but when he is introduced to a sublime
						dish he will then admit &quot;yeah, this is pretty
						good,&quot; and most crucially he is always down to
						roast some liberals.
					</p>
				}
			/>
	...
	},
	{
		...
		memeBio:
			"Probably most known for playing the board game Secret Hitler, Nathan has a tendency to print his own " +
			"set of popular board games, including construction paper squares as currency for coup (multiple people’s " +
			"least favorite game). Although he makes a valid attempt to teach said board games, his explanation of " +
			"rules is questionable. At least he tries though. He has been called “golf ball” on multiple occasions " +
			"for not doing his lit homework. A notable occurrence is when he went to the BMUN delegate dance and " +
			"actually tried to dance. Also he made maatcha, a dating platform exclusively for himself. Nathan has " +
			"the best meme templates and he is currently actively searching for gf applications:",
	},
	{
		name: "Sylvia Li",
					...
					<>
						<ul className={"list-disc pl-5"}>
							<li>
								...
								party (picture attached below for scientific
								purposes) [Editor&apos;s note: this picture is
								no longer available because nobody cares about
								science]
							</li>
							<li>
							...
							<li>
								...
								BMUN’s delegate dance and spend two hours in the
								corner of the room playing Blackjack. When not
								asked to comment, Sylvia noted that she also
								&quot;bought everyone pizza.&quot;
							</li>
						</ul>
						<p>
	...
	},
	{
		...
		memeBio: (
			<ExpandableBio
				...
				post={
					<p>
						make sure not to tell him that he isn’t knowledgeable
						enough to insult someone, lest he read another book on
						Mao Zedong. Dylan Yang takes &quot;responsibility&quot;
						to a whole other level -- which is great, considering
						his involvement in club finances. When it comes time to
						file officer reimbursements for various expenses, you
						will be shocked to know that Dylan is more proactive
						about reimbursing other people than other people are
						about reimbursing themselves -- indeed, with certain
						officers, Dylan has had to chase them down to give them
						money!! (Editor&apos;s note: the officer in question
						declined to be named. When Dylan was asked to comment,
